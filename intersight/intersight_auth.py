"""
    ...
    copied from:
    https://github.com/movinalot/intersight-rest-api/blob/master/intersight_ops.py

    This signs the request with RSA-SHA256+Private Key and builds the headers Intersight expects.
"""
